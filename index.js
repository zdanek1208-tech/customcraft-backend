...
// ========================================
// ENDPOINT: Zapisz konfigurację (ADMIN)
// ========================================

app.post('/api/config', (req, res) => {
    try {
        const { paypal_client_id, admin_key } = req.body;
        
        // Sprawdź klucz admina
        if (admin_key !== 'SpinjistuMaster') {
            return res.status(401).json({ 
                success: false, 
                message: 'Brak autoryzacji' 
